...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Zend-0679EA?style=for-the-badge&logo=zend&logoColor=white" alt="Zend"/>
...
### 🗄️ Bazy danych i chmura
- **Bazy danych:** MySQL, PostgreSQL
- **Chmura:** AWS to mój podstawowy stack, uczę się GCP i Azure

### 🌱 Aktualnie uczę się / eksperymentuję z...
- NestJS 🏗️
- Zustand (lekki stan w React)
- Firebase / Firestore
- Supabase
- Astro
...
<p align="center">  
  <a href="https://www.maxsoft.pl" target="_blank">
...
💻 Codziennie piszę kod  
⭐️ Zostaw gwiazdkę jeśli coś Ci się spodobało!
...
- **Cloud:** AWS is my primary stack, learning GCP and Azure

### 🌱 Currently learning / experimenting with...
- NestJS 🏗️
- Zustand (lightweight state in React)
- Firebase / Firestore
- Supabase
- Astro
...
⭐️ Leave a star if you like something!
